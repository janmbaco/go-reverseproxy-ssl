...
# This script helps run integration tests locally on Windows
#
...
Write-Host "✓ Service is ready! Running integration tests..." -ForegroundColor Green
Write-Host "════════════════════════════════════════════════════════════════" -ForegroundColor Cyan

# Run integration tests
Test-TimeoutAndExit "integration tests"
...
if ($exitCode -eq 0) {
    Write-Host "✓ Integration test run completed successfully" -ForegroundColor Green
} else {
    Write-Host "✗ Integration test run failed" -ForegroundColor Red
    exit $exitCode
}